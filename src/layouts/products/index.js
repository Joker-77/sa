  ...
  return (
    <DashboardLayout>
      {!show && (
        <>
          {" "}
          <DashboardNavbar name={direction == "rtl" ? "المنتجات" : "Products"} />
          <MDButton onClick={() => addNew()} color="primary">
            {direction == "rtl" ? "إضافة منتج" : "Create Product"}
          </MDButton>
          <MDInput
            style={{ marginTop: "1em" }}
                ...
                <Card>
                  ...
                  >
                    <MDTypography variant="h6" color="white">
                      {direction == "rtl" ? "جدول المنتجات" : "Products Table"}
                    </MDTypography>
                  </MDBox>
      ...
      {show && (
        <>
          <DashboardNavbar
            name={direction == "rtl" ? "إضافة أو تعديل منتج" : "Create or Edit Product"}
          />
          <CreateProduct
            direction={direction}
            isCreate={createNew}
